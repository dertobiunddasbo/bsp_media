...
export default function AprojektCase() {
  return (
    <>
      <Header />
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center">
            <div className="text-center text-white px-4 max-w-4xl">
              ...
              <p className="text-xl md:text-2xl font-extralight text-white/90">
                Authentische Mitarbeiterportraits für Recruiting
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="prose prose-lg max-w-none mb-16">
            <p className="text-xl text-dark/80 font-extralight leading-relaxed mb-6">
              Für das bundesweit tätige Bau- und Projektentwicklungsunternehmen apoprojekt haben wir eine Serie authentischer Mitarbeiterportraits produziert. An allen deutschen Standorten entstanden zweiminütige Filme, die Menschen, Rollen und Arbeitskultur unmittelbar erlebbar machen.
            </p>
            <p className="text-xl text-dark/80 font-extralight leading-relaxed mb-6">
              ...
              <div className="relative aspect-video bg-gray-200 rounded-lg overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-400 font-extralight">Mitarbeiterportrait</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative aspect-video bg-gray-200 rounded-lg overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-400 font-extralight">Social Media Cutdown</p>
                  </div>
                </div>
              </div>
            </div>
